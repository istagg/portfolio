...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// <summary>
        /// <para>A helper for the GetCellsToRecalculate method.</para>
        /// 
        /// <para>
        /// A recursive method which iterates through all dependents (direct and indirect) of a given
        /// cell, name. Determines if there is a circular dependency involving the initial cell. This method
        /// slowly builds out a LinkedList with the order in which to update the cells involved, based
        /// on the dependencies.
        /// </para>
        /// 
        /// For example:
        /// <list type="bullet">
        /// <item>A1 contains 5.</item>
        /// <item>B1 contains A1 * 2.</item>
        /// <item>C1 contains B1 / 2.</item>
        /// </list>
        /// 
        /// <para>
        /// This method would order the cells such that A1 is evaluated, then B1 is evaluated, then C1 is
        /// finally evaluated. This method does not actually evaluate the cells, just shows which order
        /// it must be done in.
        /// </para>
        /// </summary>
        /// <param name="start">The starting cell name</param>
        /// <param name="name">The current cell being evaluated</param>
        /// <param name="visited">A set of cells that have already been visited</param>
        /// <param name="changed">A LinkedList that contains the order in which to update the cells</param>
